...
echo "🔨 Building WhiskDesktop.exe (Nuitka native) for Windows via Docker..."
echo "======================================================================="
...
# Clean dist
rm -rf "$PROJECT_DIR/dist/WhiskDesktop.exe" 2>/dev/null
...
echo ""
if [ -f "dist/WhiskDesktop.exe" ]; then
    echo "✅ Nuitka build thành công!"
    echo "📍 Output: dist/WhiskDesktop.exe"
    echo "📦 Size: $(du -sh dist/WhiskDesktop.exe | cut -f1)"
